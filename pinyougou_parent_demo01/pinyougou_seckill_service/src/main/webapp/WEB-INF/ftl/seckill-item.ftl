            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img width="100%" height="100%" jqimg="${seckillGoods.smallPic}" src="${seckillGoods.smallPic}"/></span>
                    </div>
                </div>
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a href="javascript:;" @click="submitOrder()" class="sui-btn  btn-danger addshopcar">立即抢购</a>
                                </li>
                            </ul>
                        </div>
                    </div>
